...
?>		
		...
		<div id="contenu">
			<div id="map">
				<a href="./index.php?page=page0">Accueil</a> => <a href="./index.php?page=page5">Connexion</a>
			</div>
			...
			<form name="connexion" id="connexion" method="post" action="./index.php?page=page5">
				<fieldset><legend>Connexion</legend>
					<label for="pseudo" class="float-right">Pseudo :</label> <input type="text" name="pseudo" id="pseudo-co" value="<?php if(isset($_SESSION['connexion_pseudo'])) echo $_SESSION['connexion_pseudo']; ?>"/><br/>
					<label for="mdp" class="float-right">Passe :</label> <input type="password" name="mdp" id="mdp-co"/><br/>
				...
				if($result['nbr'] == 1)
				{
					...
					else
					{
						...
						$informations = Array(/*Erreur de mot de passe*/
										...
										' - <a href="'.ROOTPATH.'./index.php?page=page0">Index</a>',
										ROOTPATH.'./index.php?page=page5',
										3
										);
						require_once('information.php');
						exit();
