...
<?php
                if(array_key_exists('a', $_GET) AND $_GET['a'] == 1)
                {
                        $id = '';
                }
                
                else if(array_key_exists('a', $_GET) AND $_GET['a'] == 2)
                {
...
<!--menu//-->
                        <div class="center">
                                <?php
                                         if(array_key_exists('a', $_GET) AND $_GET['a'] == 1 || $_GET['a'] == 2)
                                        {
                                                echo '<a href="stats.php?see=connectes">Voir seulement les membres connectés</a>';
                                                $avt = 1;
                                        }
                                        
                                        if(array_key_exists('a', $_GET) AND $_GET['a'] != 2)
                                        {
                                                if($avt == 1) echo ' - ';
